            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold text-orange-500">MyStore</h3>
                        <p className="text-gray-400">
                            Bringing quality products to your doorstep since 2024.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-orange-500">Shipping Policy</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="text-gray-400 hover:text-orange-500">Electronics</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-orange-500">Clothing</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-orange-500">Accessories</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-orange-500">Home & Living</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex">
                            <input 
                                ...
                                className="px-4 py-2 rounded-l-lg w-full focus:outline-none focus:ring-2 focus:ring-orange-500"
                            />
